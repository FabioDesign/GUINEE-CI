				...
				<div class="d-flex flex-center w-lg-50 pt-15 pt-lg-0 px-10" style="background-color:#009688;">
					...
					<div class="d-flex flex-column-fluid flex-lg-start flex-column">
						...
						<div class="title-left" style="display: flex; align-items: center; width: 100%;">
							...
							<h2 class="text-white m-0" style="flex: 1; text-align: center;">Ambassade de la REPUBLIQUE de GUINEE</h2>
						...
						<div class="footer-left">
							<h3 class="text-white fw-normal m-0">Portail officiel des démarches consulaires des Ambassades de la GUINEE.</h3>
						</div>
