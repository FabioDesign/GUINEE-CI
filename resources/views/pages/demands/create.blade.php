                ...
                <div class="kt-grid__item">
                    ...
                    <div class="wizard-nav border-bottom">
                        <div class="wizard-steps p-8 p-lg-10">
                            <div class="wizard-step current" data-wizard-type="step" data-wizard-state="current" data-kt-stepper-element="nav">
                            ...
                            <div class="wizard-step" data-wizard-type="step" data-kt-stepper-element="nav">
                                <div class="wizard-label">
                                    <span class="svg-icon svg-icon-4x wizard-icon">
                            ...
                            <div class="wizard-step" data-wizard-type="step" data-kt-stepper-element="nav">
                                <div class="wizard-label">
                                    ...
                                    <h3 class="wizard-title">4. Resumé</h3>
                                </div>
                ...
                <div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
                    <div class="col-xl-12 col-xxl-7">
                        ...
                        <form class="form" id="kt_contact_add_form" data-wizard-validation="false">
                            ...
                            <div class="step1 pb-5 current" data-wizard-type="step-content" data-kt-stepper-element="content">
                                <h3 class="mb-10 font-weight-bold text-dark">Recherche :</h3>
                                <div class="row">
                                    <div class="col-xl-12">
                            ...
                            <div class="step2 pb-5" data-wizard-type="step-content" data-kt-stepper-element="content">
                                <div class="row">
                                    <div class="col-xl-12">
                                        ...
                                        <div class="form-group row align-items-center">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <div class="checkbox-inline">
                                                    ...
                                                    <input name="communication" type="checkbox" />Email
                                                    <span></span></label>
                                                    <label class="checkbox">
                                                    <input name="communication" type="checkbox" />SMS
                                                    <span></span></label>
                                                    <label class="checkbox">
                                                    <input name="communication" type="checkbox" />Phone
                                                    <span></span></label>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="step3 pb-5" data-wizard-type="step-content" data-kt-stepper-element="content">
                            ...
                            <div class="step4 pb-5" data-wizard-type="step-content" data-kt-stepper-element="content">
                            ...
                            <div class="d-flex justify-content-between border-top pt-10">
                                <div class="mr-2">
                                    <button type="button" class="btn btn-light-primary font-weight-bold px-6 py-3 fs-4 btn-previous step" data-wizard-type="action-prev" data-kt-stepper-action="previous" data-step="1">Précédent</button>
                                </div>
                                <div>
                                    <button type="button" class="btn btn-success font-weight-bold px-6 py-3 fs-4 btn-submit step" data-wizard-type="action-submit" data-kt-stepper-action="submit" data-step="1">Envoyer</button>
                                    <button type="button" class="btn btn-primary font-weight-bold px-6 py-3 fs-4 btn-next step" data-wizard-type="action-next" data-kt-stepper-action="next" data-step="1">Suivant</button>
                                </div>
                            </div>
                            <!--end::Wizard Actions-->
                        </form>
