                ...
                <div class="col-xl-12 col-xxl-7">
                    ...
                    <form class="formField" id="kt_contact_add_form" data-wizard-validation="false">
                        ...
                        <div class="body-step2 pb-5" data-wizard-type="step-content" data-kt-stepper-element="content">
                            ...
                            <div class="row mb-5">
                                <div class="col-md-4 col-12">
                                    ...
                                    <select id="civility" name="civility" class="form-control requiredUser" data-valid="0">
                                        <option value="" selected>Sélectionner</option>
                                        @foreach($civility as $civil)
                                            <option value="{{ $civil }}" @php echo $civil == optional($query->user)->civility ? 'selected':'' @endphp>{{ $civil }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-4 col-12">
                                    <label class="fw-bolder text-dark fs-5">Nom : <span class="text-danger">*</span></label>
                                    <input type="text" id="lastname" name="lastname" class="form-control requiredUser" placeholder="Saisir nom" data-valid="0" value="{{ old('lastname', optional($query->user)->lastname) }}" />
                                </div>
                                <div class="col-md-4 col-12">
                                    <label class="fw-bolder text-dark fs-5">Prénoms : <span class="text-danger">*</span></label>
                                    <input type="text" id="firstname" name="firstname" class="form-control requiredUser" placeholder="Saisir prénoms" data-valid="0" value="{{ old('firstname', optional($query->user)->firstname) }}" />
                                </div>
                            </div>
                            <div class="row mb-5">
                                <div class="col-md-4 col-12">
                                    <label class="fw-bolder text-dark fs-5">Numéro de téléphone : <span class="text-danger">*</span></label>
                                    <input type="text" id="phone_number" name="phone_number" class="form-control requiredUser" placeholder="Saisir numéro" data-valid="0" value="{{ old('phone_number', optional($query->user)->phone_number) }}" onKeyUp="verif_int(this)" />
                                </div>
                                <div class="col-md-4 col-12">
                                    <label class="fw-bolder text-dark fs-5">Email :</label>
                                    <input type="text" id="email" name="email" class="form-control email" placeholder="Saisir email" value="{{ old('email', optional($query->user)->email) }}" />
                                </div>
                                <div class="col-md-4 col-12">
                                    <label class="fw-bolder text-dark fs-5">Profession : <span class="text-danger">*</span></label>
                                    <input type="text" id="profession" name="profession" class="form-control requiredUser" placeholder="Saisir profession" data-valid="0" value="{{ old('profession', optional($query->user)->profession) }}" />
                                </div>
                            </div>
                                ...
                                <div class="col-md-3" col-12">
                                    ...
                                    <select id="town_id" name="town_id" class="form-control requiredUser" data-valid="0">
                                        ...
                                        @foreach($town as $data)
                                            <option value="{{ $data->id }}" @php echo $data->id == optional($query->user)->town_id ? 'selected':'' @endphp>{{ $data->label }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-3" col-12">
                                ...
                                <div class="col-md-4 col-12">
                                    ...
                                    <select id="nationality_id" name="nationality_id" class="form-control">
                                        ...
                                        @foreach($nationality as $data)
                                            <option value="{{ $data->id }}" data-alpha="{{ $data->alpha }}" data-code="+{{ $data->code }}" @php echo $data->id == optional($query->user)->nationality_id ? 'selected':'' @endphp>{{ $data->nationality }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-4 col-12">
                                    <label class="fw-bolder text-dark fs-5">Noms du père : <span class="text-danger">*</span></label>
                                    <input type="text" id="father_fullname" name="father_fullname" class="form-control requiredUser" placeholder="Saisir nom et prénoms du père" data-valid="0" value="{{ old('father_fullname', optional($query->user)->father_fullname) }}" />
                                </div>
                                <div class="col-md-4 col-12">
                                    <label class="fw-bolder text-dark fs-5">Noms de la mère : <span class="text-danger">*</span></label>
                                    <input type="text" id="mother_fullname" name="mother_fullname" class="form-control requiredUser" placeholder="Saisir nom et prénoms de la mère" data-valid="0" value="{{ old('mother_fullname', optional($query->user)->mother_fullname) }}" />
                                </div>
                            </div>
                            <div class="row mb-5">
                                <div class="col-md-4 col-12">
                                    <label class="fw-bolder text-dark fs-5">Taille : <span class="text-danger">*</span></label>
                                    <input type="text" id="size" name="size" class="form-control requiredUser" placeholder="Saisir taille" data-valid="0" value="{{ old('size', optional($query->user)->size) }}" />
                                </div>
                                <div class="col-md-4 col-12">
                                    <label class="fw-bolder text-dark fs-5">Teint : <span class="text-danger">*</span></label>
                                    <input type="text" id="complexion" name="complexion" class="form-control requiredUser" placeholder="Saisir teint" data-valid="0" value="{{ old('complexion', optional($query->user)->complexion) }}" />
                                </div>
                                <div class="col-md-4 col-12">
                                    <label class="fw-bolder text-dark fs-5">Cheveux : <span class="text-danger">*</span></label>
                                    <input type="text" id="hairs" name="hairs" class="form-control requiredUser" placeholder="Saisir cheveux" data-valid="0" value="{{ old('hairs', optional($query->user)->hairs) }}" />
                                </div>
                            </div>
                            <div class="row mb-5">
                                <div class="col-md-4 col-12">
                                    <label class="fw-bolder text-dark fs-5">Signes particuliers : <span class="text-danger">*</span></label>
                                    <input type="text" id="particular_sign" name="particular_sign" class="form-control requiredUser" placeholder="Saisir signes particuliers" data-valid="0" value="{{ old('particular_sign', optional($query->user)->particular_sign) }}" />
                                </div>
                                <div class="col-md-4 col-12">
                                    <label class="fw-bolder text-dark fs-5">Domicile : <span class="text-danger">*</span></label>
                                    <input type="text" id="home_address" name="home_address" class="form-control requiredUser" placeholder="Saisir domicile" data-valid="0" value="{{ old('home_address', optional($query->user)->home_address) }}" />
                                </div>
                                <div class="col-md-4 col-12">
                            ...
                            <div class="row mb-5">
                                <div class="col-md-4 col-12">
                                    ...
                                    <input type="text" id="person_fullname" name="person_fullname" class="form-control requiredUser" placeholder="Saisir nom complet" data-valid="0" value="{{ old('person_fullname', optional($query->user)->person_fullname) }}" />
                                </div>
                                <div class="col-md-4 col-12">
                                    <label class="fw-bolder text-dark fs-5">Numéro de téléphone : <span class="text-danger">*</span></label>
                                    <input type="text" id="person_number" name="person_number" class="form-control requiredUser" placeholder="Saisir numéro" data-valid="0" value="{{ old('person_number', optional($query->user)->person_number) }}" onKeyUp="verif_int(this)" />
                                </div>
                                <div class="col-md-4 col-12">
                                    <label class="fw-bolder text-dark fs-5">Adresse : <span class="text-danger">*</span></label>
                                    <input type="text" id="person_address" name="person_address" class="form-control requiredUser" placeholder="Saisir adresse" data-valid="0" value="{{ old('person_address', optional($query->user)->person_address) }}" />
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-4 col-12">
                                    ...
                                    <select id="document_id" name="document_id" class="form-control">
                                        ...
                                        @foreach($documents as $data)
                                            <option value="{{ $data->id }}" @php echo $data->id == $query->document_id ? 'selected':'' @endphp>{{ $data->label }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-2 col-12">
                                    <label class="fw-bolder text-dark fs-5">Nombre : <span class="text-danger">*</span></label>
                                    <input type="text" id="number" name="number" value="{{ old('number', $query->number) }}" class="form-control requiredDmd text-center" placeholder="0" onKeyUp="verif_int(this)" data-valid="0" />
                                </div>
                                <div class="col-md-2 col-12">
                                    <label class="fw-bolder text-dark fs-5">Montant : <span class="text-danger">*</span></label>
                                    <input type="text" id="price" name="price" value="{{ old('price', optional($query->document)->price) }}" class="form-control requiredDmd text-center" placeholder="0" onKeyUp="verif_int(this)" data-valid="0" />
                                </div>
                                <div class="col-md-2 col-12">
                                    <label class="fw-bolder text-dark fs-5">Copie : <span class="text-danger">*</span></label>
                                    <input type="text" id="copy" name="copy" value="{{ old('copy', $query->copy) }}" class="form-control requiredDmd text-center" onKeyUp="verif_int(this)" data-valid="0" />
                                </div>
                                <div class="col-md-2 col-12">
                                    <label class="fw-bolder text-dark fs-5">Total : <span class="text-danger">*</span></label>
                                    <input type="text" id="total" name="total" value="{{ old('price', $query->price) }}" class="form-control text-center" onKeyUp="verif_int(this)" />
                                </div>
                            </div>
                            <div class="row mb-5">
                                <div class="col-md-12 col-12">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-md-3 col-12">
                                            <label class="file-view fw-bolder text-dark fs-6 mt-10" style="{{ $display }}">
                                                <a href="{{ $pathFile }}" class="file-link" target="_blank">
                        ...
                        <div class="body-step4 pb-5" data-wizard-type="step-content" data-kt-stepper-element="content">
                            ...
                            <div class="row mb-5">
                                <div class="col-md-12 col-12">
                                    <label class="document_id fw-bold fs-4 text-uppercase text-dark">{{ optional($query->document)->label }}</label>
                                </div>
                            </div>
                            <div class="row mb-5">
                                <div class="col-md-3 col-12">
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            // Récupérer les alphabets des numéros de téléphone et de la personne
            ...
            // ── Aller automatiquement à l'étape 2 au chargement ─────────────────────
