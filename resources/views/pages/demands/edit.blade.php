                        ...
                        <div class="body-step2 pb-5" data-wizard-type="step-content" data-kt-stepper-element="content">
                            ...
                            <div class="row mb-5">
                                <div class="col-md-4 col-12">
                                    ...
                                    <input type="text" id="phone_number" name="phone_number" class="form-control requiredUser" onKeyUp="verif_int(this)" data-valid="0" value="{{ old('phone_number', optional($query->user)->phone_number) }}">
                                </div>
                                <div class="col-md-4 col-12">
                            ...
                            <div class="row mb-5">
                                ...
                                <div class="col-md-4 col-12">
                                    <label class="fw-bolder text-dark fs-5">Numéro de téléphone : <span class="text-danger">*</span></label>
                                    <input type="text" id="person_number" name="person_number" class="form-control requiredUser" placeholder="Saisir numéro" data-valid="0" value="{{ old('person_number', optional($query->user)->person_number) }}" />
                                </div>
                                <div class="col-md-4 col-12">
