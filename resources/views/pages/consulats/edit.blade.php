...
<div class="card">
  <div class="card-body py-4">
    <form class="formField">
      @method('PUT')
      <input type="hidden" id="rootForm" value="consulats/{{ $query->uuid }}">
        <div class="row mb-2">
          ...
          <div class="col-md-6 col-12">
            ...
            <input type="text" name="label" value="{{ old('label', $query->label) }}" class="form-control requiredField" placeholder="Saisir le consulat" />
          </div>
      </div>
