        ...
        <tbody>
          @php
            ...
            if (in_array(3, $actionIds)) {
              $href_edit = "/towns/{$data->uuid}/edit";
          ...
          <tr>
            ...
            <td class="text-end align-middle">
              <a href="/towns/{{ $data->uuid }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Voir détail de la ville" class="btn btn-icon btn-bg-light btn-sm me-1">
                <i class="ki-duotone ki-switch text-primary fs-2">
                  <span class="path1"></span>
                  <span class="path2"></span>
                </i>
              </a>
              <a href="{{ $href_edit }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Modifier la ville" class="btn btn-icon btn-bg-light btn-sm me-1">
                <i class="ki-duotone ki-pencil {{ $color_edit }} fs-2">
                  <span class="path1"></span>
                  <span class="path2"></span>
                </i>
              </a>
              <a href="#" data-url="/towns/status/{{ $data->uuid }}" data-type="PATCH" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ $action }} la ville" class="btn btn-icon btn-bg-light btn-sm me-1 {{ $class_status }}">
                <i class="ki-duotone ki-filter {{ $color_status }} fs-2">
                  <span class="path1"></span>
                  <span class="path2"></span>
                </i>
              </a>
              <a href="#" data-url="/towns/{{ $data->uuid }}" data-type="DELETE" data-bs-toggle="tooltip" data-bs-placement="top" title="Supprimé la ville" class="btn btn-icon btn-bg-light btn-sm {{ $class_delete }}">
