        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-end align-middle">
              ...
              <a href="#" data-url="/towns/status/{{ $data->uuid }}" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ $action }} la ville" class="btn btn-icon btn-bg-light btn-sm me-1 {{ $class_status }}">
