        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-end align-middle">
              ...
              <a href="#" data-url="/documents/status/{{ $data->uuid }}" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ $action }} le document" class="btn btn-icon btn-bg-light btn-sm me-1 {{ $class_status }}">
