        ...
        <tbody>
          @php
            ...
            if (in_array(3, $actionIds)) {
              $href_edit = "/documents/{$data->uuid}/edit";
          ...
          <tr>
            ...
            <td class="text-end align-middle">
              <a href="/documents/{{ $data->uuid }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Voir détail du document" class="btn btn-icon btn-bg-light btn-sm me-1">
                <i class="ki-duotone ki-switch text-primary fs-2">
                  <span class="path1"></span>
                  <span class="path2"></span>
                </i>
              </a>
              <a href="{{ $href_edit }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Modifier le document" class="btn btn-icon btn-bg-light btn-sm me-1">
                <i class="ki-duotone ki-pencil {{ $color_edit }} fs-2">
                  <span class="path1"></span>
                  <span class="path2"></span>
                </i>
              </a>
              <a href="#" data-url="/documents/status/{{ $data->uuid }}" data-type="PATCH" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ $action }} le document" class="btn btn-icon btn-bg-light btn-sm me-1 {{ $class_status }}">
                <i class="ki-duotone ki-filter {{ $color_status }} fs-2">
                  <span class="path1"></span>
                  <span class="path2"></span>
                </i>
              </a>
              <a href="#" data-url="/documents/{{ $data->uuid }}" data-type="DELETE" data-bs-toggle="tooltip" data-bs-placement="top" title="Supprimé le document" class="btn btn-icon btn-bg-light btn-sm {{ $class_delete }}">
