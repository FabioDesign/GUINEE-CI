		...
		<form class="formField">
			...
			<div class="row mb-5">
				<div class="col-md-4 col-12">
					...
					<input type="text" id="phone_number" name="phone_number" value="{{ old('phone_number', $query->phone_number) }}" class="form-control requiredField number" onKeyUp="verif_int(this)">
				</div>
				<div class="col-md-4 col-12">
