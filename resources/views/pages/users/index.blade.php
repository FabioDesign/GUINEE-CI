        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-end align-middle">
              ...
              <a href="#" data-url="/users/status/{{ $data->uuid }}" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ $action }} l'utilisateur" class="btn btn-icon btn-bg-light btn-sm me-1 {{ $class_status }}">
