        ...
        <tbody>
          @php
            ...
            if (in_array(3, $actionIds)) {
              $href_edit = "/files/{$data->uuid}/edit";
          ...
          <tr>
            ...
            <td class="text-end align-middle">
              ...
              <a href="#" data-url="/files/status/{{ $data->uuid }}" data-type="PATCH" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ $action }} le fichier" class="btn btn-icon btn-bg-light btn-sm me-1 {{ $class_status }}">
                <i class="ki-duotone ki-filter {{ $color_status }} fs-2">
                  <span class="path1"></span>
                  <span class="path2"></span>
                </i>
              </a>
              <a href="#" data-url="/files/{{ $data->uuid }}" data-type="DELETE" data-bs-toggle="tooltip" data-bs-placement="top" title="Supprimé le fichier" class="btn btn-icon btn-bg-light btn-sm {{ $class_delete }}">
